  ...
  return (
    <div>
      <section style={{ background: ed.cor, color: ed.texto_sobre_cor }}>
        <div className="gz-container" style={{ maxWidth: 1240, margin: '0 auto', padding: '56px 32px 48px' }}>
          ...
          <h1 className="gz-d-cat" style={{ fontSize: 56, fontWeight: 600, lineHeight: '58.24px', letterSpacing: '-0.8px' }}>{ed.nome}</h1>
